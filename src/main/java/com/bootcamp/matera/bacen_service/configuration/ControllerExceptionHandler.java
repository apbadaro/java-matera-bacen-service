package com.bootcamp.matera.bacen_service.configuration;
...
@RestControllerAdvice // Anotação que indica que essa classe é responsável por tratar exceções em controladores REST
public class ControllerExceptionHandler extends ResponseEntityExceptionHandler {

    // Aqui criamos metodos para tratar as exceções que podem ocorrer na aplicação
